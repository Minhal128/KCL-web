...
const features = [
  {
    ...
    title: "Smartphones",
    description:
      "KCL is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store",
  },
  {
    icon: FaTablet,
    title: "Tablet",
...
const faqs = [
  {
    ...
    answer:
      "KCL is a leading streaming platform offering a diverse library of movies and shows, including exclusive originals, blockbusters, and documentaries. Our mission is to provide seamless entertainment, tailored to your preferences, anytime, anywhere.",
  },
  {
    question: "Is streaming available worldwide?",
    answer:
      "Yes, our service is available in multiple countries. Some content may vary based on your region due to licensing agreements.",
  },
  {
    question: "What kind of content is available?",
    answer:
      "We offer a wide range of content, including new releases, classic films, popular TV series, documentaries, and exclusive KCL originals across all genres.",
  },
  {
    question: "Can I watch on multiple devices?",
    answer:
      "Yes, KCL is compatible with smartphones, tablets, smart TVs, laptops, gaming consoles, and VR headsets.",
  },
  {
    question: "How does the subscription work?",
    answer:
      "We offer flexible subscription plans—Basic, Standard, and Premium—each with different features. You can choose a monthly or yearly subscription, and you can cancel anytime.",
  },
];
  ...
  return (
    <div className="text-white bg-[#112F5A] w-screen h-screen overflow-y-auto scroll-smooth">
      ...
      <div className="">
        ...
        >
          <p className="text-[30px] sm:text-[64px] text-center font-medium">
            Discover Seamless Streaming
          </p>
          <p className="text-[30px] sm:text-[64px] text-center font-medium -mt-2">
            Experience With KCL
          </p>
          <p className="text-center text-[#C5DDFF] text-[1rem] sm:text-[24px] mt-5">
            Stream the stories you love, discover new favorites, and <br />{" "}
            enjoy exclusive premieres. Watch anywhere, anytime
          </p>
          <button
            className="w-[308px] h-[68px] mt-10 rounded-[500px] bg-[#12B037] text-white text-[21.54px] font-medium shadow-[0_11px_29px_0_rgba(20,169,144,0.3)] hover:opacity-90 transition-opacity duration-200"
            onClick={handleBtn}
          >
            Start Watching
          </button>
        ...
        <div id="features" className="bg-[#112F5A] py-10">
          <div className="text-center">
            ...
            <p className="text-[#C5DDFF] text-lg sm:text-xl mt-3">
              Stream on the go with your phone or enjoy <br /> cinematic moments
              on your smart TV.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 md:p-10 lg:px-20 mt-10">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex flex-col p-6 rounded-lg bg-white/5 border border-white/10 backdrop-blur-sm shadow-[0_10px_20px_rgba(0,0,0,0.1)]"
              >
                ...
                <p className="text-sm text-[#C5DDFF] mt-2">
                  {feature.description}
                </p>
              </div>
            ))}
        ...
        <div id="plans" className="bg-white py-10">
          <div className="text-center text-[#112F5A]">
            ...
            <p className="text-[#112F5A] text-lg sm:text-xl mt-3">
              Choose the subscription that fits your lifestyle — monthly,
              yearly, or pay-per-view
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 md:p-10 lg:px-20 mt-10">
            {pricingPlans.map((plan, index) => (
              <div
                key={index}
                className="flex flex-col px-8 py-4 rounded-lg border border-gray-300 shadow-md bg-[#dddddd]"
              >
                <h3 className="text-2xl font-semibold text-[#112F5A]">
                  {plan.name}
                </h3>
                ...
                <div className=" mt-4">
                  <span className="text-4xl font-bold text-[#112F5A]">
                    {plan.price}
                  </span>
                  <span className="text-lg text-[#8C9BB4]">
                    {plan.duration}
                  </span>
                </div>
                <div className="flex justify-center gap-x-4 mt-8">
                  <button
                    className="flex-1 py-3 px-6 rounded-full bg-[#828A92] text-[#fff] font-semibold transition-colors duration-200"
                    onClick={handleBtn}
                  >
                    Start Free Trial
                  </button>
                  <button
                    className="flex-1 py-3 px-6 rounded-full bg-[#12B037] text-white font-semibold hover:opacity-90 transition-opacity duration-200"
                    onClick={handleBtn}
                  >
                    Choose Plan
                  </button>
        ...
        <div className="bg-[#112F5A] py-10">
          <div className="text-center">
            ...
            <p className="text-[#C5DDFF] text-lg sm:text-xl mt-3">
              From action-packed blockbusters to heartfelt dramas, comedies,
              documentaries,
            </p>
          </div>
          {/* Genre */}
          ...
          >
            {genres.map((genre, index) => (
              <div
                key={index}
                className="flex flex-col p-6 rounded-lg bg-white/5 border border-white/10 backdrop-blur-sm shadow-[0_10px_20px_rgba(0,0,0,0.1)] relative overflow-hidden"
              >
                <img
                  src={genre.image}
                  alt={genre.title}
                ...
                />
                <div className="">
                  <div className="bg-[#12B037] text-white text-xs font-medium px-2 py-1 rounded-md w-fit mb-2">
                    Top 10 in
                  </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start border-b border-gray-600 pb-10 mb-6">
              <div className="w-full md:w-2/5">
                ...
                <p className="text-sm text-[#C5DDFF]">
                  Stream the stories you love, discover new favorites, and enjoy
                  exclusive premieres.
                </p>
              </div>
                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className="flex space-x-4">
                    <a
                      href="#"
                      aria-label="Facebook"
                      className="text-[#C5DDFF] hover:text-white transition-colors duration-200"
                    >
                      <FaFacebookF size={20} />
                    </a>
                    <a
